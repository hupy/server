...
public class ClusterControllerTest extends BaseTestCase {
    ...
    public void T020Get() throws Exception {
        mockMvc.perform(get("/api/cluster/{id}", 1))
                .andDo(print())
                .andExpect(MockMvcResultMatchers.jsonPath("$.resultCode").value(ResultStat.OK.responseCode))
                .andExpect(status().isOk());
    }
    ...
    public void T090GetNodeInfo() throws Exception {
        mockMvc.perform(get("/api/cluster/{id}/node/{name}", 3, "bx-42-197"))
                .andDo(print())
                .andExpect(MockMvcResultMatchers.jsonPath("$.resultCode").value(ResultStat.OK.responseCode))
                .andExpect(status().isOk());
    }
    ...
    public void T100GetNodeInstanceInfo() throws Exception {
        mockMvc.perform(get("/api/cluster/{id}/nodelist/{name}", 3, "bx-42-197"))
                .andDo(print())
                .andExpect(MockMvcResultMatchers.jsonPath("$.resultCode").value(ResultStat.OK.responseCode))
                .andExpect(status().isOk());
    }
    ...
    public void T120GetNodeByLabels() throws Exception {
        mockMvc.perform(get("/api/cluster/{id}/nodelistwithlabels", 3).param("labels", "{\"kubernetes.io/hostname\":\"bx-42-201\"}"))
                .andDo(print())
                .andExpect(MockMvcResultMatchers.jsonPath("$.resultCode").value(ResultStat.OK.responseCode))
                .andExpect(status().isOk());
    }
    ...
    public void T140DeleteLabel() throws Exception {
        mockMvc.perform(delete("/api/cluster/{id}/{nodeName}/{label}", 3, "bx-42-197", "test-label"))
                .andDo(print())
                .andExpect(MockMvcResultMatchers.jsonPath("$.resultCode").value(ResultStat.OK.responseCode))
                .andExpect(status().isOk());
    }
    ...
    public void T150AddDisk() throws Exception {
        mockMvc.perform(post("/api/cluster/{id}/{nodeName}/disk", 3, "bx-42-197").param("path", "pathOfDisk"))
                .andDo(print())
                .andExpect(MockMvcResultMatchers.jsonPath("$.resultCode").value(ResultStat.OK.responseCode))
                .andExpect(status().isOk());
    }
    ...
    public void T160DeleteDisk() throws Exception {
        mockMvc.perform(delete("/api/cluster/{id}/{nodeName}/disk", 3, "bx-42-197"))
                .andDo(print())
                .andExpect(MockMvcResultMatchers.jsonPath("$.resultCode").value(ResultStat.OK.responseCode))
                .andExpect(status().isOk());
    }
